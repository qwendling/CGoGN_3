...
public:
	...
	ShaderParamPointSprite(ShaderType* sh)
		: ShaderParam(sh, true), color_(1, 1, 1, 1), ambiant_color_(0.05f, 0.05f, 0, 1), light_position_(1000, 10000, 100000),
...
public:
	...
	ShaderParamPointSpriteColor(ShaderType* sh)
		: ShaderParam(sh, true), ambiant_color_(0.05f, 0.05f, 0, 1), light_position_(1000, 10000, 100000), point_size_(2),
...
public:
	...
	ShaderParamPointSpriteColorSize(ShaderType* sh)
		: ShaderParam(sh, true), ambiant_color_(0.05f, 0.05f, 0, 1), light_position_(1000, 10000, 100000),
		  plane_clip_(0, 0, 0, 0), plane_clip2_(0, 0, 0, 0)
	{
	}
