...
ShaderExplodeVolumesColorSmooth* ShaderExplodeVolumesColorSmooth::instance_ = nullptr;

ShaderExplodeVolumesColorSmooth::ShaderExplodeVolumesColorSmooth()
{
...
void ShaderParamExplodeVolumesColorSmooth::bind_texture_buffers()
{
	vbos_[VERTEX_POSITION]->bind_texture_buffer(11);
	vbos_[VOLUME_CENTER]->bind_texture_buffer(12);
	vbos_[VOLUME_COLOR]->bind_texture_buffer(13);
...
void ShaderParamExplodeVolumesColorSmooth::release_texture_buffers()
{
	vbos_[VERTEX_POSITION]->release_texture_buffer(11);
	vbos_[VOLUME_CENTER]->release_texture_buffer(12);
	vbos_[VOLUME_COLOR]->release_texture_buffer(13);
